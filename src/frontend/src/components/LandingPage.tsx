...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-sprint-bg-primary relative overflow-hidden animate-fade-in">
      {/* Navigation */}
      <nav className="w-full px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-sprint-surface rounded-lg shadow-sm flex items-center justify-center">
            <div className="grid grid-cols-2 gap-0.5">
              <div className="w-2 h-2 bg-sprint-text-primary rounded-sm" />
              <div className="w-2 h-2 bg-sprint-text-primary rounded-sm" />
              <div className="w-2 h-2 bg-sprint-text-primary rounded-sm" />
              <div className="w-2 h-2 bg-sprint-text-primary rounded-sm" />
            </div>
      ...
      <main className="relative max-w-7xl mx-auto px-6 pt-16 pb-32">
        ...
        <div className="absolute left-4 top-8 lg:left-12 lg:top-16 animate-float z-10">
          <div className="relative">
            {/* Pin */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-3 h-3 bg-red-700 rounded-full shadow-md z-10" />
            {/* Note */}
        ...
        <div className="absolute left-4 bottom-16 lg:left-8 lg:bottom-24 animate-float z-10 hidden sm:block">
          <div className="w-56 bg-sprint-surface rounded-xl shadow-float p-4">
            <h4 className="font-semibold text-sprint-text-primary text-sm mb-3">
              Active Tasks
            </h4>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-orange-100 rounded flex items-center justify-center text-xs text-orange-800">
                  3
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <div className="flex-1 h-1 bg-sprint-bg-secondary rounded-full overflow-hidden">
                    ...
                    <div className="flex -space-x-1">
                      <div className="w-4 h-4 rounded-full bg-green-400 border border-sprint-surface" />
                      <div className="w-4 h-4 rounded-full bg-blue-400 border border-sprint-surface" />
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-green-100 rounded flex items-center justify-center text-xs text-green-800">
                  3
                </div>
                <div className="flex-1">
                  <p className="text-xs text-sprint-text-primary">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <div className="flex -space-x-1">
                      <div className="w-4 h-4 rounded-full bg-purple-400 border border-sprint-surface" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="absolute right-4 top-8 lg:right-12 lg:top-12 animate-float z-10 hidden sm:block">
          <div className="w-48 bg-sprint-surface rounded-xl shadow-float p-4">
            <div className="flex items-center justify-between mb-3">
              <h4 className="font-semibold text-sprint-text-primary text-sm">
                Upcoming
              </h4>
              <span className="text-[10px] text-sprint-text-tertiary px-2 py-0.5 bg-sprint-bg-secondary rounded">
                Sessions
              </span>
            </div>
        ...
        <div className="absolute right-8 top-56 lg:right-24 lg:top-64 animate-float-delayed z-10">
          <div className="w-14 h-14 bg-sprint-surface rounded-xl shadow-float flex items-center justify-center">
            <div className="relative">
              <div className="w-10 h-10 border-2 border-sprint-text-tertiary rounded-full flex items-center justify-center">
                <div className="w-0.5 h-3 bg-sprint-text-secondary absolute origin-bottom -translate-y-1 rotate-45" />
                <div className="w-0.5 h-2 bg-sprint-text-secondary absolute origin-bottom -translate-y-0.5" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="w-48 bg-sprint-surface rounded-xl shadow-float p-4">
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-blue-400 border-2 border-sprint-surface flex items-center justify-center text-[10px] font-bold text-white">
                  AB
                </div>
                <div className="w-8 h-8 rounded-full bg-green-400 border-2 border-sprint-surface flex items-center justify-center text-[10px] font-bold text-white">
                  CD
                </div>
                <div className="w-8 h-8 rounded-full bg-purple-400 border-2 border-sprint-surface flex items-center justify-center text-[10px] font-bold text-white">
                  EF
                </div>
              </div>
              <div className="flex-1">
        ...
        <div className="text-center pt-20 pb-8 relative z-20">
          ...
          <div className="inline-flex mb-8">
            <div className="w-16 h-16 bg-sprint-surface rounded-2xl shadow-lg flex items-center justify-center">
              <div className="grid grid-cols-2 gap-1">
                <div className="w-4 h-4 bg-sprint-text-primary rounded-md" />
                <div className="w-4 h-4 bg-sprint-text-primary rounded-md" />
                <div className="w-4 h-4 bg-sprint-text-primary rounded-md" />
                <div className="w-4 h-4 bg-sprint-text-primary rounded-md" />
              </div>
      ...
      <div className="fixed bottom-6 right-6 z-30">
        <div className="bg-sprint-surface rounded-lg shadow-md px-4 py-2 flex items-center gap-2">
          <span className="text-xs text-sprint-text-tertiary">Powered by</span>
          <div className="flex items-center gap-1">
            <div className="w-5 h-5 bg-gradient-to-br from-purple-500 to-pink-500 rounded rotate-45" />
