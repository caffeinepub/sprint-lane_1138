...
export const DraggableCard: React.FC<DraggableCardProps> = ({
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (!state.isDragging && e.key === "Enter") {
      setShowModal(true);
    }
  };
  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-sprint-surface rounded-lg shadow-sm border border-sprint-border/50 p-3 cursor-grab active:cursor-grabbing hover:shadow-card-hover hover:border-sprint-accent-300/50 hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm transition-all duration-150 group select-none"
      >
        {/* Card Title */}
