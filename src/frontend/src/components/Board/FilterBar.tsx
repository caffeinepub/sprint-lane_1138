...
import type { BoardMember, Tag, UserProfile } from "../../backend.d";
    ...
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {tags.length > 0 && (
        <div ref={tagDropdownRef} className="relative">
          ...
          {showTagDropdown && (
            <div className="absolute left-0 top-full mt-1 bg-sprint-surface rounded-lg shadow-lg border border-sprint-border py-1 z-30 min-w-[200px] max-h-64 overflow-y-auto">
              {tags.map((tag) => {
      ...
      {members.length > 0 && (
        <div ref={assigneeDropdownRef} className="relative">
          ...
          {showAssigneeDropdown && (
            <div className="absolute left-0 top-full mt-1 bg-sprint-surface rounded-lg shadow-lg border border-sprint-border py-1 z-30 min-w-[220px] max-h-64 overflow-y-auto">
              {/* Unassigned option */}
              <button
                type="button"
