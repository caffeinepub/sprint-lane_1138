  ...
  return (
    <>
      <button
        ...
        className="w-full text-left bg-sprint-surface rounded-lg shadow-sm border border-sprint-border/50 p-3 cursor-pointer hover:shadow-md hover:border-sprint-accent-300/50 transition-all group"
      >
        {/* Card Title */}
