      ...
      <div className="text-center max-w-md px-4">
        ...
        <div className="w-20 h-20 bg-sprint-accent-50 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <div className="grid grid-cols-3 gap-1.5">
            <div className="w-4 h-8 bg-sprint-accent-300 rounded" />
            <div className="w-4 h-6 bg-sprint-accent-400 rounded" />
            <div className="w-4 h-10 bg-sprint-accent-500 rounded" />
          </div>
        </div>
        ...
        {/* Create Board */}
        {isCreating ? (
          <div className="bg-sprint-surface rounded-xl shadow-sm border border-sprint-border p-4 max-w-sm mx-auto">
            <input
              type="text"
