...
import { useCreateBoard, useMyBoards } from "../../hooks/useQueries";
    ...
    <>
      ...
      <aside
        className={`
          ...
          w-60 bg-sprint-surface border-r border-sprint-border
      ...
      >
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-sprint-accent-500 rounded-lg flex items-center justify-center">
              <div className="grid grid-cols-2 gap-0.5">
                <div className="w-2 h-2 bg-sprint-surface rounded-sm" />
                <div className="w-2 h-2 bg-sprint-surface rounded-sm" />
                <div className="w-2 h-2 bg-sprint-surface rounded-sm" />
                <div className="w-2 h-2 bg-sprint-surface rounded-sm" />
              </div>
        ...
        <div className="border-t border-sprint-border p-3 space-y-1">
          <button
            type="button"
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-sprint-text-secondary hover:bg-red-900/20 hover:text-red-400 rounded-lg transition-all duration-150"
          >
            <svg
              aria-hidden="true"
              className="w-4 h-4"
