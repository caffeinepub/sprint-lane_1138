  ...
  return (
    <div className="h-screen bg-sprint-bg-primary flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile Header */}
        <header className="lg:hidden h-14 bg-sprint-surface border-b border-sprint-border flex items-center px-4 gap-3">
          <button
            type="button"
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-sprint-accent-500 rounded-lg flex items-center justify-center">
              <div className="grid grid-cols-2 gap-0.5">
                <div className="w-1.5 h-1.5 bg-sprint-surface rounded-sm" />
                <div className="w-1.5 h-1.5 bg-sprint-surface rounded-sm" />
                <div className="w-1.5 h-1.5 bg-sprint-surface rounded-sm" />
                <div className="w-1.5 h-1.5 bg-sprint-surface rounded-sm" />
              </div>
