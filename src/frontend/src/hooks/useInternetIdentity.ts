...
export function InternetIdentityProvider({
  ...
  // Store auth client in a ref -- never in state -- so it cannot trigger re-renders or effect loops
  ...
  // authClientRef and initializedRef are refs, not state -- they cannot trigger this effect
  useEffect(() => {
